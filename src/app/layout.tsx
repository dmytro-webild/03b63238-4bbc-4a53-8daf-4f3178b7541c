...
export const metadata: Metadata = {
  title: "IslamicHub - Islamic Education & Wellness Super App",  description: "All-in-one Islamic app with 1100+ features: Tasbeeh counter, AI assistant, Quran, mental wellness, learning library, kids mode, and more. Fast, secure, offline-first.",  keywords: "Islamic app, Quran, prayer times, Islamic education, mental wellness, tasbeeh counter, AI assistant, Islamic tools",  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    title: "IslamicHub - Your Complete Islamic & Educational Companion",    description: "1100+ integrated features for Islamic education, wellness, productivity, and spiritual growth in one secure, lightweight app.",    type: "website",    siteName: "IslamicHub",    images: [
      {
        url: "http://img.b2bpic.net/free-vector/goals-habits-tracking-app-screens-collection_23-2148616460.jpg",        alt: "IslamicHub App Dashboard"},
    ],
  },
  twitter: {
    card: "summary_large_image",    title: "IslamicHub - Islamic App",    description: "Complete Islamic education and wellness platform with 1100+ features",    images: ["http://img.b2bpic.net/free-vector/goals-habits-tracking-app-screens-collection_23-2148616460.jpg"],
  },
};
